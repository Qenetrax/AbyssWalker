...
Dialog {
    ...
    // Signals
    signal uploadRequested(string local, string remote, string agent)
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    TextField {
                        ...
                        placeholderText: qsTr("Select file to upload...")
            ...
            ColumnLayout {
                ...
                TextField {
                    ...
                    Layout.fillWidth: true
                    Layout.preferredHeight: 44
                    placeholderText: qsTr("Destination path on agent (e.g., C:\\temp\\file.exe)")
                    font.family: "Fira Code"
                    font.pixelSize: 13
                    color: textColor
                    text: remotePath
    ...
    footer: Rectangle {
        ...
        RowLayout {
            ...
            Button {
                text: uploading ? qsTr("Cancel") : qsTr("Close")
                font.family: "Fira Sans"
                onClicked: {
                    if (uploading) {
                        cancelRequested()
            ...
            Button {
                ...
                onClicked: {
                    uploading = true
                    uploadRequested(localPath, remotePath, agentId)
                }
    ...
    function isFormValid() {
        return localPath !== "" && remotePath !== "" && agentId !== ""
    }
